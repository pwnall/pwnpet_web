...
describe "command_results/new.html.erb" do
  before(:each) do
    assign(:command_result, stub_model(CommandResult,
      :shell_session_id => 1,
      :command => "MyText",
      :stdin => "MyText",
      :stdout => "MyText",
  ...
  it "renders new command_result form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => command_results_path, :method => "post" do
